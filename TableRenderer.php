...
class TableRenderer implements TableRendererInterface
{
     ...
     * Constructor.
     *
     * @param TableRendererEngineInterface    $engine
     */
    ...
    public function searchAndRenderBlock(TableView $view, $blockNameSuffix, array $variables = array())
    {
        ...
        // "table_widget" in this example (again, no matter in which theme).
        // If the designer wants to explicitly fallback to "table_widget" in his
        ...
        // is found for its parent "table_widget", then the level is updated here
        // to the parent level.
